...
prepareInputDataGyrCov <- function(d_trans, d_obs, d_rodent, d_gyr, localities = NULL, areas = NULL, areaAggregation, excl_neverObs = TRUE, R_perF, R_parent_drop0, sumR.Level = "group", dataVSconstants = TRUE, addDummyDim = TRUE, save = TRUE){
