...
input_data <- prepareInputData_Integ_full(d_trans = LT_data$d_trans, 
                                     d_obs = LT_data$d_obs,
                                    #d_cmr = d_cmr,
                                     d_rodent = d_rodent,
...
## Write model code
modelCode <- writeModelCode_Integ_full(survVarT = survVarT,
...
model_setup <- setupModel_Integ_full(modelCode = modelCode,
                                R_perF = R_perF,
                                survVarT = survVarT, 
